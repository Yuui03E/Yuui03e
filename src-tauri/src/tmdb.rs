...
/// Normalize a title for fuzzy comparison — lowercase, strip punctuation, collapse
/// whitespace. Mirrors the spirit of `parser::normalize_title` without importing it,
...
pub async fn fetch_backdrops(api_key: &str, tmdb_id: i64, kind: TmdbKind) -> Vec<String> {
    let resp = CLIENT
