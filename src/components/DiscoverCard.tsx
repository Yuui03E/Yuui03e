...
export default function DiscoverCard({
  ...
  // Use the unique AniList media.id exclusively — loose title string matching
  // causes false positives between remakes/sequels sharing the same title.
  const localEntry = entries.find((e) => e.media?.id === anime.id);
